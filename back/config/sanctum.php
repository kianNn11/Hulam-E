...
return [
    ...
    */
    ...
    | when working with multiple Sanctum configurations within a single app
    | that each need their own personal access token prefix to avoid conflicts.
    |
    */

    'token_prefix' => 'hulame_',
